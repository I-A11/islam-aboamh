export default function Footer() {
  return (
    ...
    >
      <p className="font-mono text-sm text-signal">05 / What&apos;s next?</p>
      ...
      <p className="mt-4 max-w-md text-sm leading-relaxed text-mist">
        ...
        projects. If you have an opportunity, a question, or just want to say
        hi, my inbox is open.
      </p>
      <a
        href="mailto:hello@islamaboamh.com"
